...
> 状态：生效｜规范版本：1.0｜最后更新：2026-07-19
...
3. [视觉设计系统](DESIGN_SYSTEM.md)：颜色、排版、间距、组件和无障碍标准。
4. [动效与文案规范](MOTION_AND_CONTENT.md)：页面过渡、反馈节奏和用户可见文字。
5. [Git 协作规范](GIT_WORKFLOW.md)：分支、提交、PR、版本和回滚规则。
6. [质量检查清单](QUALITY_CHECKLIST.md)：功能完成前逐项勾选。
7. [技术架构明细](ARCHITECTURE.md)：当前数据模型、工程边界和版本路线。
